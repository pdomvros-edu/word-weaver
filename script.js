...
function initGame() {
    ...
    console.log("5. Switched to wordSelectionScreen.");
    updateScoreDisplay();
    console.log("6. Score display updated.");
}

function renderBaseWordSelection() {
    console.log("7. renderBaseWordSelection() started.");
    ...
    console.log("8. Base word selection buttons rendered. Count:", gameData.base_words.length);
}

function selectBaseWord(wordData) {
    console.log("9. selectBaseWord() called with:", wordData.word);
    if (!wordData?.word || !Array.isArray(wordData.derivatives)) {
        console.error('Invalid word data:', wordData);
        return;
    }
    console.log("10. Word data valid.");
    ...
    console.log("11. renderAffixes() called from selectBaseWord().");
    
    elements.baseWordDisplay.textContent = currentBaseWordData.word;
    showScreen('gameScreen');
    updateScoreDisplay();
    console.log("12. Game screen displayed for:", currentBaseWordData.word);
}

function renderAffixes() {
    console.log("13. renderAffixes() started.");
    elements.prefixList.innerHTML = '';
    elements.suffixList.innerHTML = '';
    console.log("14. Affix lists cleared in HTML.");

    // Check if gameData.common_prefixes exists and has items
    if (gameData.common_prefixes && gameData.common_prefixes.length > 0) {
        console.log("15. Attempting to add prefixes. Count:", gameData.common_prefixes.length);
        gameData.common_prefixes.forEach(prefix => {
            ...
            // console.log("Added prefix:", prefix); // Uncomment for very detailed logging
        });
        console.log("16. Prefixes loop finished.");
    } else {
        console.warn("gameData.common_prefixes is empty or undefined!");
    }


    // Check if gameData.common_suffixes exists and has items
    if (gameData.common_suffixes && gameData.common_suffixes.length > 0) {
        console.log("17. Attempting to add suffixes. Count:", gameData.common_suffixes.length);
        gameData.common_suffixes.forEach(suffix => {
            ...
            // console.log("Added suffix:", suffix); // Uncomment for very detailed logging
        });
        console.log("18. Suffixes loop finished.");
    } else {
        console.warn("gameData.common_suffixes is empty or undefined!");
    }
    console.log("Exiting renderAffixes() function.");
}

function toggleAffixSelection(affix, type, element) {
    console.log("19. toggleAffixSelection() called for:", affix, type);
    if (type === 'prefix') {
...
function updateWordConstructionArea() {
    console.log("20. updateWordConstructionArea() called.");
...
function resetWordConstruction() {
    console.log("21. resetWordConstruction() called.");
    selectedPrefix = null;
    selectedSuffix = null;
    constructedWord = '';
...
function buildAndCheckWord() {
    console.log("22. buildAndCheckWord() called.");
...
function addWordToFoundList(derivative) {
    console.log("23. addWordToFoundList() called for:", derivative.word);
...
function showFeedback(message, type) {
    console.log("24. showFeedback() called:", message, type);
...
elements.nextWordBtn.addEventListener('click', () => {
    console.log("25. Next Base Word button clicked.");
    showScreen('wordSelectionScreen');
    renderBaseWordSelection();
});
...
console.log("26. DOMContentLoaded event listener registered. Script parsed.");
